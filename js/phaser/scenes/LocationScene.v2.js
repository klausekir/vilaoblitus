...
class LocationScene extends Phaser.Scene {
    ...
    renderPuzzle() {
        ...
        // Prism Light puzzle: Se resolvido, NÃO renderizar nada visualmente
        // Isso permite que o hotspot (definido na localização) fique acessível sem bloqueios
        if (puzzle.type === 'prism_light' && isSolved) {
            console.log('✨ Prisma resolvido - Visual removido para liberar hotspot.');
            return;
        }
